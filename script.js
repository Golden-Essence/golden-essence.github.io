// Define the common Header (Logo + Navigation)
const headerContent = `
    <div class="logo">
...
// Define the common Footer
const footerContent = `
    <p>&copy; 2026 Golden Essence Pvt Ltd. All rights reserved.</p>
`;

document.addEventListener('DOMContentLoaded', () => {
    // 1. Inject Header and Footer into the placeholders
    ...
    // 2. Highlight the active navigation link based on the current URL
    // If the path is empty (e.g., just the root folder), default to index.html
